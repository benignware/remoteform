...
},{"./isElement":18}],13:[function(require,module,exports) {
'use strict';
...
},{"./isElement":18}],4:[function(require,module,exports) {
'use strict';
...
},{"./getID":9,"./getClasses":10,"./getCombinations":11,"./getAttributes":12,"./getNthChild":14,"./getTag":13,"./isUnique":15,"./getParents":16}],17:[function(require,module,exports) {
'use strict';
...
},{"./utils":17,"./formats":8}],7:[function(require,module,exports) {
'use strict';
...
},{"./stringify":6,"./parse":7,"./formats":8}],5:[function(require,module,exports) {
'use strict';
          ...
          if (remoteElement) {
            ...
            try {
              for (var _iterator2 = remoteElement.attributes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                targetElement.setAttribute(_name, value);
              }
              // Update content
            } catch (err) {
              _didIteratorError2 = true;
...
},{"unique-selector":4,"qs":3,"get-form-data":5}],19:[function(require,module,exports) {
...
if (!module.bundle.parent && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket('ws://' + hostname + ':' + '62832' + '/');
